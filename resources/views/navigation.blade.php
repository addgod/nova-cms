...
<ul class="list-reset mb-8">
    <li class="leading-tight mb-4 ml-8 text-sm">
        <router-link tag="a" :to="{name: 'index', params: {resourceName: 'pages'}}" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
            Pages
        </router-link>
    </li>
</ul>
